...
public class BlockRoomsMod {
    ...
    public BlockRoomsMod(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = BlockRoomsMod.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
